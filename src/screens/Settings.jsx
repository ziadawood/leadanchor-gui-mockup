  ...
  return (
    <div className="min-h-full bg-app pb-10">
      <div className="bg-white border-b border-gray-200 p-4 sticky top-0 z-10">
        <h1 className="text-xl font-heading font-bold text-navy-900">Settings</h1>
      </div>
      ...
      <div className="p-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 overflow-hidden">
          <div className="p-4 bg-navy-900 text-white flex items-center justify-between">
            ...
            <div className="bg-white text-navy-900 text-xs font-bold px-3 py-1 rounded-full uppercase">
              Starter Plan
            </div>
          </div>
        </div>
            ...
            {sections.map(section => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="bg-gray-100 p-2 rounded-lg text-navy-500">
                    <section.icon className="w-5 h-5" />
                  </div>
                  <span className="font-semibold text-sm text-navy-900">{section.label}</span>
                </div>
  ...
  return (
    <div className="min-h-full bg-app flex flex-col pb-10">
      <div className="bg-white border-b border-gray-200 p-4 sticky top-0 z-10 flex items-center gap-2">
        ...
        <h1 className="text-xl font-heading font-bold text-navy-900">Plan & Billing</h1>
      </div>

      <div className="p-4">
        <div className="bg-card rounded-2xl p-6 border-2 border-gray-200 shadow-sm mb-6">
          <h3 className="font-heading font-bold text-xl text-navy-900 mb-1">STARTER</h3>
          <div className="mb-4">
            <span className="text-3xl font-bold text-navy-900">$45</span>
            <span className="text-gray-500 text-sm">/mo</span>
          </div>
          <button onClick={() => navigate('/plans')} className="w-full bg-emerald-500 text-white font-bold py-3 rounded-xl hover:bg-emerald-600 transition-colors shadow-md">
            Upgrade to Pro
          </button>
        </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-sm font-semibold mb-1">
                <span className="text-navy-900">Calls Captured</span>
                <span className="text-gray-500">12 / 100</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-navy-500 h-2 rounded-full w-[12%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between text-sm font-semibold mb-1">
                <span className="text-navy-900">Messages Sent (SMS/RCS)</span>
                <span className="text-gray-500">45 / 500</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div className="bg-navy-500 h-2 rounded-full w-[9%]"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-navy-50 border border-navy-100 rounded-xl p-4 mb-6 relative overflow-hidden">
          ...
          <h3 className="font-bold text-navy-900 text-sm mb-1 relative z-10">Website Add-on</h3>
          <p className="text-xs text-gray-600 mb-4 relative z-10 w-3/4">$149 one-time + $5/mo — your own LeadAnchor-powered site.</p>
          <button className="bg-white text-navy-900 font-bold text-xs py-2 px-4 rounded-lg shadow-sm border border-gray-200 relative z-10">
            Learn More
          </button>
        </div>
  ...
  return (
    <div className="min-h-full bg-app flex flex-col pb-10">
      <div className="bg-white border-b border-gray-200 p-4 sticky top-0 z-10 flex items-center gap-2">
        ...
        <h1 className="text-xl font-heading font-bold text-navy-900">Integrations</h1>
      </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-gray-100 rounded flex items-center justify-center font-bold text-navy-900">T</div>
              <h3 className="font-bold text-navy-900">Telnyx (Voice & SMS)</h3>
            </div>
          ...
          <div className="bg-gray-50 border border-gray-200 p-2 rounded text-xs font-semibold text-gray-600">
            Tracking Number: +44 7123 456789
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-navy-900">Google Business Profile</h3>
            </div>
            <button className="text-xs font-bold text-navy-700 bg-navy-50 px-3 py-1.5 rounded-lg border border-navy-200">Connect</button>
          </div>
          <p className="text-xs text-gray-500">Automate review requests and sync business info.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-navy-900">Stripe</h3>
            </div>
            <div className="flex items-center gap-1 text-[10px] font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded-full uppercase">
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500"></div> Connected
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 opacity-70">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-bold text-gray-900">WhatsApp (Telnyx)</h3>
            </div>
            <Lock className="w-4 h-4 text-gray-400" />
          </div>
          <p className="text-xs text-gray-500 mb-2">Send deposits and handle customer chats.</p>
          <div className="flex gap-2">
            <div className="bg-gray-100 px-2 py-1 rounded text-[10px] font-bold text-gray-500 inline-block">PRO FEATURE</div>
            <div className="flex items-center gap-1 text-[10px] text-gray-400">
               <HelpCircle className="w-3 h-3" /> 24hr window applies
            </div>
          </div>
        </div>
      </div>
